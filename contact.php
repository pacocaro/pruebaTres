      ...
      <div id="content">
        ...
        <form id="contact" action="contact.php" method="post">
          <div class="form_settings">
            <p><span>Name</span><input class="contact" type="text" name="your_name" value="<?php if (isset($yourname)) {
              echo $yourname;
            } ?>" /></p>
            <p><span>Email Address</span><input class="contact" type="text" name="your_email" value="<?php if (isset($youremail
            )) {
              echo $youremail;
            } ?>" /></p>
            <p><span>Message</span><textarea class="contact textarea" rows="5" cols="50" name="your_message"><?php if (isset($yourmessage)) {
             echo $yourmessage;} ?></textarea></p>
